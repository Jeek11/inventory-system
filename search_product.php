...
<div class="container mt-5 table-container glowing-table-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="ms-auto">
                        <form method="POST" action="inventory.php" class="d-flex align-items-center">
                            <button type="submit" class="btn btn-danger btn-lg d-flex align-items-center">
                                <i class="fas fa-reply me-1"></i> Back to inventory
                            </button>
                        </form>
                    </div>
                  </div>
    ...
    <div class="d-flex justify-content-center">
        <nav>
            <ul class="pagination">
                <?php if ($page > 1): ?>
                    <li class="page-item"><a class="page-link" href="search_products.php?page=<?php echo $page - 1; ?>&search=<?php echo htmlspecialchars($search); ?>">Previous</a></li>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                        <a class="page-link" href="search_products.php?page=<?php echo $i; ?>&search=<?php echo htmlspecialchars($search); ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>

                <?php if ($page < $total_pages): ?>
                    <li class="page-item"><a class="page-link" href="search_products.php?page=<?php echo $page + 1; ?>&search=<?php echo htmlspecialchars($search); ?>">Next</a></li>
                <?php endif; ?>
            </ul>
        </nav>
    </div>
